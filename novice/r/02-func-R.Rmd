...
<img src="figure/python-call-stack-01.png" alt="Call Stack (Initial State)" />
...
<img src="figure/python-call-stack-02.png" alt="Call Stack Immediately After First Function Call" />

When we call `fahr_to_kelvin` inside `fahr_to_celsius`, R creates another stack frame to hold `fahr_to_kelvin`'s variables:

<img src="figure/python-call-stack-03.png" alt="Call Stack During First Nested Function Call" />
...
<img src="figure/python-call-stack-04.png" alt="Call Stack After Return From First Nested Function Call" />

It then calls `kelvin_to_celsius`, which means it creates a stack frame to hold that function's variables:

<img src="figure/python-call-stack-05.png" alt="Call Stack During Call to Second Nested Function" />

Once again, R throws away that stack frame when `kelvin_to_celsius` is done
and creates the variable `result` in the stack frame for `fahr_to_celsius`:

<img src="figure/python-call-stack-06.png" alt="Call Stack After Second Nested Function Returns" />
...
<img src="figure/python-call-stack-07.png" alt="Call Stack After All Functions Have Finished" />
